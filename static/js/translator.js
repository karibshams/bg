...
(function () {
  ...
  const translations = {
    ...
    // Smart Date Search & Proximity Matching
    'Alternative dates available nearby': { en: 'Alternative dates available nearby', bn: 'কাছাকাছি বিকল্প যাত্রার তারিখ' },
    'কাছাকাছি বিকল্প যাত্রার তারিখ': { en: 'Alternative dates available nearby', bn: 'কাছাকাছি বিকল্প যাত্রার তারিখ' },
    'Smart Proximity Matching': { en: 'Smart Proximity Matching', bn: 'স্মার্ট প্রক্সিমিটি ম্যাচিং' },
    'Exact Departure Date Match': { en: 'Exact Departure Date Match', bn: 'নির্দিষ্ট যাত্রার তারিখের মিল' },
    'নির্দিষ্ট যাত্রার তারিখের মিল': { en: 'Exact Departure Date Match', bn: 'নির্দিষ্ট যাত্রার তারিখের মিল' },
    'Clear Date Filter': { en: 'Clear Date Filter', bn: 'তারিখ ফিল্টার মুছুন' },
    'তারিখ ফিল্টার মুছুন': { en: 'Clear Date Filter', bn: 'তারিখ ফিল্টার মুছুন' },
    'View All Dates': { en: 'View All Dates', bn: 'সকল তারিখ দেখুন' },
    'সকল তারিখ দেখুন': { en: 'View All Dates', bn: 'সকল তারিখ দেখুন' },
    'Clear Date & Show All Tours': { en: 'Clear Date & Show All Tours', bn: 'তারিখ মুছে সকল ট্যুর দেখুন' },
    'তারিখ মুছে সকল ট্যুর দেখুন': { en: 'Clear Date & Show All Tours', bn: 'তারিখ মুছে সকল ট্যুর দেখুন' },
    'No Departures Found for this Date': { en: 'No Departures Found for this Date', bn: 'এই তারিখে কোনো যাত্রার তারিখ পাওয়া যায়নি' },
    'এই তারিখে কোনো যাত্রার তারিখ পাওয়া যায়নি': { en: 'No Departures Found for this Date', bn: 'এই তারিখে কোনো যাত্রার তারিখ পাওয়া যায়নি' },
    'Search Tours': { en: 'Search Tours', bn: 'ট্যুর খুঁজুন' },
    'ট্যুর খুঁজুন': { en: 'Search Tours', bn: 'ট্যুর খুঁজুন' },
    'Available Departure Date:': { en: 'Available Departure Date:', bn: 'উপলব্ধ যাত্রার তারিখ:' },
    'উপলব্ধ যাত্রার তারিখ:': { en: 'Available Departure Date:', bn: 'উপলব্ধ যাত্রার তারিখ:' },
    'Alternative Date': { en: 'Alternative Date', bn: 'বিকল্প তারিখ' },
    'বিকল্প তারিখ': { en: 'Alternative Date', bn: 'বিকল্প তারিখ' },
    'seats left': { en: 'seats left', bn: 'সিট বাকি' },
    'সিট বাকি': { en: 'seats left', bn: 'সিট বাকি' },
    ...
    'Mandatory Notice: Please Save Your Booking Reference ID!': { en: 'Mandatory Notice: Please Save Your Booking Reference ID!', bn: 'জরুরি নোটিশ: বুকিং রেফারেন্স আইডিটি সংরক্ষণ করা বাধ্যতামূলক!' },
    'জরুরি নোটিশ: বুকিং রেফারেন্স আইডিটি সংরক্ষণ করা বাধ্যতামূলক!': { en: 'Mandatory Notice: Please Save Your Booking Reference ID!', bn: 'জরুরি নোটিশ: বুকিং রেফারেন্স আইডিটি সংরক্ষণ করা বাধ্যতামূলক!' },
    'Mandatory Notice: Save Your Booking Reference ID': { en: 'Mandatory Notice: Save Your Booking Reference ID', bn: 'জরুরি নোটিশ: বুকিং রেফারেন্স আইডিটি সংরক্ষণ করা বাধ্যতামূলক' },
    'জরুরি নোটিশ: বুকিং রেফারেন্স আইডিটি সংরক্ষণ করা বাধ্যতামূলক': { en: 'Mandatory Notice: Save Your Booking Reference ID', bn: 'জরুরি নোটিশ: বুকিং রেফারেন্স আইডিটি সংরক্ষণ করা বাধ্যতামূলক' },
    'Accurate Payment Notice — Strict Verification Policy': { en: 'Accurate Payment Notice — Strict Verification Policy', bn: 'সঠিক পেমেন্ট নোটিশ — কঠোর ভেরিফিকেশন নীতিমালা' },
    'সঠিক পেমেন্ট নোটিশ — কঠোর ভেরিফিকেশন নীতিমালা': { en: 'Accurate Payment Notice — Strict Verification Policy', bn: 'সঠিক পেমেন্ট নোটিশ — কঠোর ভেরিফিকেশন নীতিমালা' },
    'Accurate Payment Notice & Verification Policy': { en: 'Accurate Payment Notice & Verification Policy', bn: 'সঠিক পেমেন্ট নোটিশ ও ভেরিফিকেশন নীতিমালা' },
    'সঠিক পেমেন্ট নোটিশ ও ভেরিফিকেশন নীতিমালা': { en: 'Accurate Payment Notice & Verification Policy', bn: 'সঠিক পেমেন্ট নোটিশ ও ভেরিফিকেশন নীতিমালা' },
    'Booking Rejected': { en: 'Booking Rejected', bn: 'বুকিং প্রত্যাখ্যাত হয়েছে' },
    'বুকিং প্রত্যাখ্যাত হয়েছে': { en: 'Booking Rejected', bn: 'বুকিং প্রত্যাখ্যাত হয়েছে' },
    'Booking Rejected / Not Approved': { en: 'Booking Rejected / Not Approved', bn: 'বুকিং প্রত্যাখ্যাত / বাতিল করা হয়েছে' },
    'বুকিং প্রত্যাখ্যাত / বাতিল করা হয়েছে': { en: 'Booking Rejected / Not Approved', bn: 'বুকিং প্রত্যাখ্যাত / বাতিল করা হয়েছে' },
    'Specific Reason:': { en: 'Specific Reason:', bn: 'প্রত্যাখ্যানের কারণ:' },
    'প্রত্যাখ্যানের কারণ:': { en: 'Specific Reason:', bn: 'প্রত্যাখ্যানের কারণ:' },
    'Payment Verified & Booking Confirmed!': { en: 'Payment Verified & Booking Confirmed!', bn: 'পেমেন্ট যাচাই সম্পন্ন ও বুকিং নিশ্চিত হয়েছে!' },
    'পেমেন্ট যাচাই সম্পন্ন ও বুকিং নিশ্চিত হয়েছে!': { en: 'Payment Verified & Booking Confirmed!', bn: 'পেমেন্ট যাচাই সম্পন্ন ও বুকিং নিশ্চিত হয়েছে!' },
    'Payment Under Verification': { en: 'Payment Under Verification', bn: 'পেমেন্ট ভেরিফিকেশন চলছে' },
    'পেমেন্ট ভেরিফিকেশন চলছে': { en: 'Payment Under Verification', bn: 'পেমেন্ট ভেরিফিকেশন চলছে' },
    'Re-submit Payment Details →': { en: 'Re-submit Payment Details →', bn: 'সঠিক তথ্য দিয়ে পুনরায় চেষ্টা করুন →' },
    'সঠিক তথ্য দিয়ে পুনরায় চেষ্টা করুন →': { en: 'Re-submit Payment Details →', bn: 'সঠিক তথ্য দিয়ে পুনরায় চেষ্টা করুন →' },
    'Copy Reference': { en: 'Copy Reference', bn: 'রেফারেন্স কপি' },
    'রেফারেন্স কপি': { en: 'Copy Reference', bn: 'রেফারেন্স কপি' },
    ...
    'Bus Seat Reservation': { en: 'Bus Seat Reservation', bn: 'বাসের আসন সংরক্ষণ' },
    'বাসের আসন সংরক্ষণ': { en: 'Bus Seat Reservation', bn: 'বাসের আসন সংরক্ষণ' },
    'Assigned Seats:': { en: 'Assigned Seats:', bn: 'সংরক্ষিত আসন:' },
    'সংরক্ষিত আসন:': { en: 'Assigned Seats:', bn: 'সংরক্ষিত আসন:' },
    'Change Seats': { en: 'Change Seats', bn: 'আসন পরিবর্তন করুন' },
    'আসন পরিবর্তন করুন': { en: 'Change Seats', bn: 'আসন পরিবর্তন করুন' },
    'Select Bus Seats Now': { en: 'Select Bus Seats Now', bn: 'এখনই আসন নির্বাচন করুন' },
    'এখনই আসন নির্বাচন করুন': { en: 'Select Bus Seats Now', bn: 'এখনই আসন নির্বাচন করুন' },
    'Confirm Bus Seat Selection': { en: 'Confirm Bus Seat Selection', bn: 'আসন সংরক্ষণ নিশ্চিত করুন' },
    'আসন সংরক্ষণ নিশ্চিত করুন': { en: 'Confirm Bus Seat Selection', bn: 'আসন সংরক্ষণ নিশ্চিত করুন' },
    'Available': { en: 'Available', bn: 'খালি' },
    'খালি': { en: 'Available', bn: 'খালি' },
    'Occupied': { en: 'Occupied', bn: 'বুকড' },
    'বুকড': { en: 'Occupied', bn: 'বুকড' },
    'EXCLUSIVE PHOTO GALLERY': { en: 'EXCLUSIVE PHOTO GALLERY', bn: 'এক্সক্লুসিভ ফটো গ্যালারি' },
    'এক্সক্লুসিভ ফটো গ্যালারি': { en: 'EXCLUSIVE PHOTO GALLERY', bn: 'এক্সক্লুসিভ ফটো গ্যালারি' },
    'Full View': { en: 'Full View', bn: 'বড় করে দেখুন' },
    'বড় করে দেখুন': { en: 'Full View', bn: 'বড় করে দেখুন' },
    'Full Gallery': { en: 'Full Gallery', bn: 'পুরো গ্যালারি' },
    'পুরো গ্যালারি': { en: 'Full Gallery', bn: 'পুরো গ্যালারি' },
    'Slider View': { en: 'Slider View', bn: 'স্লাইডার ভিউ' },
    'স্লাইডার ভিউ': { en: 'Slider View', bn: 'স্লাইডার ভিউ' },
    'Grid View': { en: 'Grid View', bn: 'গ্রিড ভিউ' },
    'গ্রিড ভিউ': { en: 'Grid View', bn: 'গ্রিড ভিউ' },
